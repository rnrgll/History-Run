...
public class Q5QuizManager : MonoBehaviour
{
    public int PlayCount;
    public TextMeshProUGUI tryNumText;

    public List<Q5QuestionAndAnswers> QnA;
    ...
    public Q5PopUpSystem popUpSystem;
    public Q5SetResult Pass;
    public Q5SetResult Fail;
    ...
    private void Awake()
    {
        ...
        {
            PlayCount = PlayerPrefs.GetInt("Q5GamePlayCount");
    ...
    public void start()
    {
        ...
        {
            PlayCount++;
            PlayerPrefs.SetInt("Q5GamePlayCount", PlayCount);
        }
        else
        {
            PlayCount++;
    ...
    void gameOver()
    {
        ...
        if (score >= pass)
        {
            ...
            PlayerPrefs.SetString("Quest5PlayLog", "GameClear");
        }
        else
        {
            Failbgm.Play();
    ...
    public void generateQuestion()
    {
        ...
        if (QnA.Count > 0)
        {
            ...
            HintManager.GetComponent<Q5HintManager>().generateHint(currentQuestionNum);
